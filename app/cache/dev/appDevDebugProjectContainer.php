...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Noob\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Noob\\TagBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Noob\\PostBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Noob\\SiteBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Noob\\CommentBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Noob\\MessagerieBundle\\Entity')));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c7f474d322e18d891e6c67383ced7a9dd88d06fcb754aa3170fa61a1ea3660bb');
    ...
    protected function getSecurity_Firewall_Map_Context_UserSecuredService()
    {
        ...
        return $this->services['security.firewall.map.context.user_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.user_security')), 'user_secured', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'user_secured', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5543685a25425', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'user_secured', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Noob\\UserBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Noob\\TagBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Noob\\PostBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Noob\\SiteBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Noob\\UserBundle/Resources/views'), 'NoobUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Noob\\TagBundle/Resources/views'), 'NoobTag');
        $instance->addPath(($this->targetDirs[3].'\\src\\Noob\\PostBundle/Resources/views'), 'NoobPost');
        $instance->addPath(($this->targetDirs[3].'\\src\\Noob\\SiteBundle/Resources/views'), 'NoobSite');
        $instance->addPath(($this->targetDirs[3].'\\src\\Noob\\CommentBundle/Resources/views'), 'NoobComment');
        $instance->addPath(($this->targetDirs[3].'\\src\\Noob\\MessagerieBundle/Resources/views'), 'NoobMessagerie');
