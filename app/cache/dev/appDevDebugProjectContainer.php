...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            'kernel.root_dir' => 'C:/wamp/www/interfaceieps/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/wamp/www/interfaceieps/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/interfaceieps/app/logs',
            'kernel.bundles' => array(
                ...
                'NoobUserBundle' => 'Noob\\UserBundle\\NoobUserBundle',
                'NoobTagBundle' => 'Noob\\TagBundle\\NoobTagBundle',
                'NoobPostBundle' => 'Noob\\PostBundle\\NoobPostBundle',
                'NoobSiteBundle' => 'Noob\\SiteBundle\\NoobSiteBundle',
                'NoobCommentBundle' => 'Noob\\CommentBundle\\NoobCommentBundle',
                'NoobMessagerieBundle' => 'Noob\\MessagerieBundle\\NoobMessagerieBundle',
            ...
            'locale' => 'fr',
            'secret' => 'WhatDoYouMeanMyTokenIsNotSecret',
            ...
            'kernel.secret' => 'WhatDoYouMeanMyTokenIsNotSecret',
            ...
            'session.save_path' => 'C:/wamp/www/interfaceieps/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/interfaceieps/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/interfaceieps/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => 'C:/wamp/www/interfaceieps/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/interfaceieps/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/interfaceieps/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/interfaceieps/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/interfaceieps/app/../web',
            'assetic.write_to' => 'C:/wamp/www/interfaceieps/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/interfaceieps/app/cache/dev/doctrine/orm/Proxies',
            ...
            'ewz_recaptcha.public_key' => '6Le3xAUTAAAAALkfLONP340y6XX3Rv7PW--XMF-_',
            'ewz_recaptcha.private_key' => '6Le3xAUTAAAAAA748VXEkIaUhu2yl8AM2wlFALaM',
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.user_secured' => 'getSecurity_Firewall_Map_Context_UserSecuredService',
            ...
            'security.user.provider.concrete.user_security' => 'getSecurity_User_Provider_Concrete_UserSecurityService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/interfaceieps/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/interfaceieps/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/interfaceieps/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/interfaceieps/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'interfaceieps', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\UserBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\TagBundle\\Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\PostBundle\\Entity'), 3 => (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\SiteBundle\\Entity'), 4 => (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\CommentBundle\\Entity'), 5 => (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\MessagerieBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Noob\\UserBundle\\Entity');
        $c->addDriver($b, 'Noob\\TagBundle\\Entity');
        $c->addDriver($b, 'Noob\\PostBundle\\Entity');
        $c->addDriver($b, 'Noob\\SiteBundle\\Entity');
        $c->addDriver($b, 'Noob\\CommentBundle\\Entity');
        $c->addDriver($b, 'Noob\\MessagerieBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('NoobUserBundle' => 'Noob\\UserBundle\\Entity', 'NoobTagBundle' => 'Noob\\TagBundle\\Entity', 'NoobPostBundle' => 'Noob\\PostBundle\\Entity', 'NoobSiteBundle' => 'Noob\\SiteBundle\\Entity', 'NoobCommentBundle' => 'Noob\\CommentBundle\\Entity', 'NoobMessagerieBundle' => 'Noob\\MessagerieBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir('C:/wamp/www/interfaceieps/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8374243af9c6b0d2667a240c5df7fbd4aae962e3c7ded704e02acff8235a0cfc');
    ...
    {
        return $this->services['ewz_recaptcha.form.type'] = new \EWZ\Bundle\RecaptchaBundle\Form\Type\RecaptchaType('6Le3xAUTAAAAALkfLONP340y6XX3Rv7PW--XMF-_', true, false, 'fr');
    }
    ...
    {
        return $this->services['ewz_recaptcha.validator.true'] = new \EWZ\Bundle\RecaptchaBundle\Validator\Constraints\TrueValidator(true, '6Le3xAUTAAAAAA748VXEkIaUhu2yl8AM2wlFALaM', $this->get('request_stack'));
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/interfaceieps/app/Resources');
    }
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), 'C:/wamp/www/interfaceieps/app/cache/dev', array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'LiipImagineBundle' => 'Liip\\ImagineBundle\\LiipImagineBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'EWZRecaptchaBundle' => 'EWZ\\Bundle\\RecaptchaBundle\\EWZRecaptchaBundle', 'NoobUserBundle' => 'Noob\\UserBundle\\NoobUserBundle', 'NoobTagBundle' => 'Noob\\TagBundle\\NoobTagBundle', 'NoobPostBundle' => 'Noob\\PostBundle\\NoobPostBundle', 'NoobSiteBundle' => 'Noob\\SiteBundle\\NoobSiteBundle', 'NoobCommentBundle' => 'Noob\\CommentBundle\\NoobCommentBundle', 'NoobMessagerieBundle' => 'Noob\\MessagerieBundle\\NoobMessagerieBundle', 'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    {
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($this->get('liip_imagine.mime_type_guesser'), $this->get('liip_imagine.extension_guesser'), 'C:/wamp/www/interfaceieps/app/../web');
    }
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver($this->get('filesystem'), $this->get('router.request_context'), 'C:/wamp/www/interfaceieps/app/../web', 'media/cache');
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('WhatDoYouMeanMyTokenIsNotSecret');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'profil' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 230, 1 => 230), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'mini' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 65, 1 => 65), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'very_big' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 800, 1 => 800), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'thumb_preview' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 131, 1 => 131), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    {
        return $this->services['liip_imagine.filter.loader.paste'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($this->get('liip_imagine'), 'C:/wamp/www/interfaceieps/app');
    }
    ...
    {
        return $this->services['liip_imagine.filter.loader.watermark'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader($this->get('liip_imagine'), 'C:/wamp/www/interfaceieps/app');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/interfaceieps/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/interfaceieps/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/interfaceieps/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/interfaceieps/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Noob\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha256', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'), 'security.firewall.map.context.user_secured' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.user_security')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.user_secured' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_UserSecuredService()
    {
        $a = $this->get('security.context');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        $c = $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        ...
        $h->setOptions(array('login_path' => '/login', 'default_target_path' => '/user/dashboard', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $h->setProviderKey('user_secured');
        ...
        return $this->services['security.firewall.map.context.user_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.user_security')), 'user_secured', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'user_secured', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5542ae9ad973f', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'user_secured', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/interfaceieps/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/interfaceieps/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/interfaceieps/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/interfaceieps/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('user_secured', '/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/interfaceieps/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.bg.xlf'), 'bg', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.de.xlf'), 'de', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.en.xlf'), 'en', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.es.xlf'), 'es', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.fr.xlf'), 'fr', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.nl.xlf'), 'nl', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.pl.xlf'), 'pl', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.ru.xlf'), 'ru', 'validators');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/translations\\validators.uk.xlf'), 'uk', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\UserBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\TagBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\PostBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\SiteBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/interfaceieps/app', 'UTF-8'));
        ...
        $instance->addGlobal('defaultProfilePicture', 'defaultsilouhette.jpg');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\excelwebzone\\recaptcha-bundle\\EWZ\\Bundle\\RecaptchaBundle/Resources/views'), 'EWZRecaptcha');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\UserBundle/Resources/views'), 'NoobUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\TagBundle/Resources/views'), 'NoobTag');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\PostBundle/Resources/views'), 'NoobPost');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\SiteBundle/Resources/views'), 'NoobSite');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\CommentBundle/Resources/views'), 'NoobComment');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Noob\\MessagerieBundle/Resources/views'), 'NoobMessagerie');
        ...
        $instance->addPath('C:/wamp/www/interfaceieps/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('WhatDoYouMeanMyTokenIsNotSecret');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/interfaceieps/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/interfaceieps/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/samot/login'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/samot'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_STUDENT' => array(0 => 'ROLE_USER'), 'ROLE_ENTREPRISE' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_SUPER_ADMIN', 3 => 'ROLE_ALLOWED_TO_SWITCH')));
    }

    /**
     * Gets the 'security.user.provider.concrete.user_security' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_UserSecurityService()
    {
        return $this->services['security.user.provider.concrete.user_security'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Noob\\UserBundle\\Entity\\User', NULL, NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/interfaceieps/app/cache/dev');
    }
