...
/* NoobUserBundle:Profil:likesListPage.html.twig */
class __TwigTemplate_51b196f548b251251732fc0a2e3f3787e1d16a04cf563ef027e1993499aacca8 extends Twig_Template
{
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col-lg-12\">
                <header>
                  <h1><span class=\"xl-size\">Coups de coeur</span> de ";
        // line 9
...
<section class=\"board grey\">
    <div class=\"container pb\" id=\"updatehere\">
        ";
        // line 23
        $this->env->loadTemplate("NoobUserBundle:Profil:completeListContent.html.twig")->display(array_merge($context, array("itemList" => $this->getContext($context, "postsLiked"), "itemType" => "post")));
        // line 24
        echo "    </div>
</section>
";
    ...
    \$('body').on('click', '.load-more', function(e){
        if(currEvent){
            ...
            \$.ajax({
                ...
                url: \"";
        // line 40
        echo $this->env->getExtension('routing')->getPath("noob_user_profilcompleteListAjax", array("contentType" => "postsLiked"));
        echo "\",
                data: {itemid:";
        // line 41
...
";
    ...
    {
        return "NoobUserBundle:Profil:likesListPage.html.twig";
    }
