...
/* NoobUserBundle:Profil:followingListPage.html.twig */
class __TwigTemplate_169aa248797525a489bfe37670a9561826443a20d1511ae31b92c7a64304d099 extends Twig_Template
{
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col-lg-12\">
                <header>
                  <h1><span class=\"xl-size\">Membres suivis</span> par ";
        // line 9
...
<section class=\"board grey\">
    <div class=\"container pb\" id=\"updatehere\">
        ";
        // line 23
        $this->env->loadTemplate("NoobUserBundle:Profil:completeListContent.html.twig")->display(array_merge($context, array("itemList" => $this->getContext($context, "followingsList"), "itemType" => "user")));
        // line 24
        echo "    </div>
</section>
";
    ...
    \$('body').on('click', '.load-more', function(e){
        if(currEvent){
            ...
            \$.ajax({
                ...
                url: \"";
        // line 40
        echo $this->env->getExtension('routing')->getPath("noob_user_profilcompleteListAjax", array("contentType" => "followings"));
        echo "\",
                data: {itemid:";
        // line 41
...
";
    ...
    {
        return "NoobUserBundle:Profil:followingListPage.html.twig";
    }
